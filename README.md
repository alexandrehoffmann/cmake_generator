...
- 📝 Generate CMakeLists.txt from simple YAML configuration
- 🎯 Support for executables and libraries (static/shared)
- 📦 Dependency management with find_package
- ⚙️ Compiler settings (C++ standard, flags, warnings)
- 🔧 Installation rules
